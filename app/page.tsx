...
export default function Home() {
  const {
    ...
    addProject, updateProject, deleteProject, addTask, deleteTask, addTaskGroup, deleteTaskGroup, addTaskToGroup, removeTaskFromGroup, addTemplate, updateTemplate, deleteTemplate,
